...
void RX_JY901(void)
{
	...
	z_w=mean_fliter(&yaw_w_filter,(double)(stcGyro.w[2]*101725)*(1e-8));//32768*2000/60//单位转化为rpm，同时进行均值滤波
	z_angle=((float)stcAngle.Angle[2]/32768+1)*4095.5f;//转化为0-8191
